  ...
  return (
    <div className="update">
      ...
      <InputGroup className="mb-3">
        <InputGroup.Text>Hafalan dan Bacaan</InputGroup.Text>
        <Form.Control aria-label="Username" />
        <Form.Control aria-label="Password" />
      </InputGroup>
      <InputGroup className="mb-3">
        <InputGroup.Text>Makna Quran dan Hadits</InputGroup.Text>
        <Form.Control aria-label="Username" />
        <Form.Control aria-label="Password" />
      </InputGroup>
      <InputGroup className="mb-3">
        <InputGroup.Text>Adzan dan Praktik Sholat</InputGroup.Text>
        <Form.Control aria-label="Username" />
        <Form.Control aria-label="Password" />
      </InputGroup>
